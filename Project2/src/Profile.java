 ...
 * the valid departments. name is the name of the person to whom this profile
 * belongs to. departmentt is the name of the department where that person works
 * at. dateHired is the date when the person was hired.
 *
...
public class Profile {
   ...
   /**
    * Overridden toString method which outputs the formatted string of a Profile
    * class. Format: Doe,Jane::CS::7/1/2020
    * 
